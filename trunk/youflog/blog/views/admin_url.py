...
urlpatterns = patterns('',
    ...
    url(r'^admin/allposts',admin.all_posts,name='all_posts'),
    ...
    url(r'^admin/post$',admin.admin_addpost,name="add_post"), #跳转到文章添加页面
    ...
    url(r'admin/page$',admin.addPage,name='add_page'), #跳转到页面添加
    url(r'admin/pages$',admin.pages,name='show_all_pages'),#分页显示所有的页面
    url(r'admin/posts_cate/(?P<slug>[-\w]+)$',admin.posts_by_category),
    #comment
    url(r'^admin/comments',admin.comments,name="show_all_comments"), #分页显示所有的评论
    ...
    #category
    url(r'^admin/categories',admin.categories,name='show_categories'),
    ...
    #links
    url(r'^admin/links',admin.links,name='show_all_links'),
    ...
    url(r'^admin/settings/save$',admin.save_setting,name='save_settings'), #保持设置
    url(r'^admin/comment_setting$',admin.setting_comment,name="comment_settings"),
    url(r'^admin/save_commentOption$',admin.save_commentOption),
    url(r'^admin/permalink$',admin.permalink,name="permalink"),
    url(r'^admin/save_permalink',admin.save_permalink),
    url(r'^admin/backup_db$',admin.backup_db,name="backup_db"),
    
    url(r'^admin/users$',admin.users,name="show_users"),
    url(r'^admin/profile',admin.profile,name="user_profile"),
    url(r'^admin/saveprofile',admin.saveprofile),
    
    #media
    url(r'^admin/tools$',admin.tools,name='tools'),
